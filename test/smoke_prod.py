...
from utils.data_loader import load_package_data_outstaff, load_package_data_e_com, load_service_data
...
def test_page_meta_data(driver, meta_data):
    ...
    assert form_page_test.get_title_ceo_page() == meta_data["title"], f"Получен Title:  {form_page_test.get_title_ceo_page()}"
    assert form_page_test.get_descr_ceo_page() == meta_data["description"], f"Получен Description:  {form_page_test.get_descr_ceo_page()}"
    assert form_page_test.get_canonical_ceo_page() == meta_data["canonical"], f"Получен Canonical:  {form_page_test.get_canonical_ceo_page()}"
